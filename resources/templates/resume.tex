...
\cvheadingstart
  ...
  \cvitem{Owned the Loss of Funding process for two years: refactored legacy code, resolved production defects, and produced documentation and trainings to transfer ownership; enabled customer facing teams to reclaim revenue of over 1.5 million dollars per year}
  \cvitemend
...
\cvitemstart
  ...
  \cvitem{\href{https://github.com/BenjaBelnap/Parry-God}{\textbf{Parry God:}} 48-hour game jam — complete game built in Godot under tight deadline with one partner.}
